...
- **스트림잇에서 한국어 TTS 구현하기**:  📄[노트](https://www.notion.so/TTS-1-134df982be6580049d22fc8a8f2f2500?pvs=21)
...
- **내 컴퓨터를 웹서버로 만들어 홈페이지화 하기**:  📄[노트](https://www.notion.so/136df982be65801296fbc9ec10c094c2?pvs=21)

- **로그인을 위한 회원 가입 화면 만들기**:  📄[노트](https://www.notion.so/136df982be658053a5c8eb520e99c71a?pvs=21)

- **API 이용해서 Chatgpt 와 연동하기**:  📄[노트](https://www.notion.so/API-Chatgpt-137df982be658013a1baeb452caf4d57?pvs=21)

- **부트스트랩 이용하여 쉽게 결제 화면 만들기**:  📄[노트](https://www.notion.so/138df982be65803c873ec562bc96a1a2?pvs=21)

- **홈페이지 생성을 위한 템플릿 (구현 설명)**:  📄[노트](https://www.notion.so/138df982be65809da9ecd335a94c10f9?pvs=21)

- **심리상담 모델 파인 튜닝과정 상세히 정리**:  📄[노트](https://www.notion.so/13bdf982be65802f85b2e62faa1970c0?pvs=21)

- **스마트폰에서 실시간으로 웹캠 보이게 하는 방법**:  📄[노트](https://www.notion.so/13cdf982be65805daf71c44ee3c466e3?pvs=21)

- **템플릿으로 홈페이지 첫 화면 만들기**:  📄[노트](https://www.notion.so/13edf982be6580ff84c1dde66daa06c3?pvs=21)
